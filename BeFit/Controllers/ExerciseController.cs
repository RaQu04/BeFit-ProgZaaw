...
namespace BeFit.Controllers
{
    public class ExerciseController : Controller
    {
        ...
        {
            ViewData["ExerciseTypeId"] = new SelectList(_context.ExerciseType, "Name", "Name");
        ...
        public async Task<IActionResult> Create([Bind("Id,Weight,NumOfSessions,NumOfReps,SessionId,ExerciseTypeId")] Exercise exercise)
        {
            ...
            ViewData["ExerciseTypeId"] = new SelectList(_context.ExerciseType, "Name", "Name", exercise.ExerciseTypeId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Weight,NumOfSessions,NumOfReps,SessionId,ExerciseTypeId")] Exercise exercise)
        {
            if (id != exercise.Id)
            {
                return NotFound();
